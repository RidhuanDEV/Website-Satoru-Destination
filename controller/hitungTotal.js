function hitungTotalPembayaran() {
    ...
    document.getElementById('totalPembayaran').innerText = 'Total Pembayaran: Rp ' + totalPembayaran.toLocaleString('id-ID', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
}
